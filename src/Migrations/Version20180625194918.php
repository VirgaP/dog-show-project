 ...
 */
final class Version20180625194918 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dogs CHANGE pedigree_reg_no pedigree_reg_no VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dogs CHANGE pedigree_reg_no pedigree_reg_no VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
